...
class RecipeBox extends React.Component { // Displayes recipe Names
    ...
    handleOnClick = (recipe) => {
        ...
        ingredients = ingredients.split("/,").map((element, index) => {
            return <li key={index}>{element}</li>
        });
        instructions = instructions.split("/,").map((element, index) => {
            return <li key={index}>{element}</li>
        });
                        ...
                        {recipeList.map((element, index) => {
                            return <div key={element.id}>
                                ...
                                <div className='displayInline'>
                                    <i role='button' className="fa fa-pencil fa-lg" aria-hidden="true" onClick={() => this.onEdit(element)}></i>
                                    <i role='button' className="fa fa-ban fa-lg" aria-hidden="true" onClick={() => this.props.onDelete(element.id)}></i>
                                </div>
                            </div>
                        })}
                    </ul>
